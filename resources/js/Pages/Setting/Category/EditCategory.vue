    ...
    <modal :show="ShowingModalEdit" @close="closeModal">
        <div class="p-4" v-if="currentCategory !== null">
            ...
            <div class="mb-4">
                ...
                <div v-if="categoryError" class="text-sm font-semibold opacity-80 text-white bg-rose-500 p-2 rounded absolute top-0 right-2/4 translate-x-2/4">
                    {{ categoryError }}
                </div>
            </div>
            ...
            <div v-if="productError" class="text-sm font-semibold text-white bg-rose-500 opacity-80 p-2 rounded absolute bottom-0 right-2/4 translate-x-2/4">
                {{ productError }}
            </div>
